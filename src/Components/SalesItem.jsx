...
const SalesItem = () => {
  ...
  const onIndexChange = (selectedIndex) => {
    setSelectedIndex(selectedIndex % 2) // Toggle between 0 and 1
  }
  ...
  return (
    <Card className="max-w-full mx-auto">
      <Flex className="space-x-8 flex-col lg:flex-row">
        ...
        <TabGroup index={selectedIndex} onIndexChange={onIndexChange}>
      ...
      <Text className="mt-3">Portfolio Value</Text>
